...
exports.createOrderDB = async (
  ...
  try {
    console.log("Creating order with data:", discount, payableAmount);
    // start transaction
    ...
    const [orderResult] = await conn.query(
      `INSERT INTO orders (delivery_type, customer_type, customer_id, table_id, token_no, payment_status, invoice_id, tenant_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
      [
        deliveryType,
        customerType,
        customerId,
    ...
    (order_id, item_id, variant_id, price, discount_amount ,quantity, notes, addons, tenant_id)
    VALUES ?
    `;
